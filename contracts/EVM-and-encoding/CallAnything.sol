...
contract CallAnything {
    ...
    function getSelectorOne() public pure returns(bytes4 selector) {
        // https://www.educative.io/answers/what-is-hashing-with-keccak256-in-solidity
...
contract CallFunctionWithoutContract {
    ...
    function callTransferFunctionDirectlyThree(address someAddress, uint256 amount)
        ...
        returns (bytes4, bool)
    {
        // the best practice is to try avoid such low level call functions in other contract
        // it's better if you can import an interface so that you can have the compiler on the side
